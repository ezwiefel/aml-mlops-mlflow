...
def parse_args() -> Namespace:
    ...
    parser.add_argument("--version", '-v', type=int,
                        ...
                        default=None)
    parser.add_argument("--async", "-q", action="store_true",
...
def main(name: str, version: int, async: bool, local: bool, force: bool):
...
if __name__ == "__main__":
    ...
    main(name=args.name, version=args.version,
         async=args.async, local=args.local, force=args.force)
